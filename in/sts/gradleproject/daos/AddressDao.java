...
public class AddressDao {
	public int addressdetailsinsert(EmployeeModel empmodel) throws Exception
	{
		...
		try
		{
			...
			if(con!=null)
			{
				...
				pstmt.setString(2,empmodel.getCity());
				pstmt.setString(3,empmodel.getCountry());
				pstmt.setInt(4,empmodel.getPincode());
